    ...
    class ParserIPG2
    {
        ...
        public static void run()
        {
            ...
            {                              
                ...
                patentItem.patentNumber = "X";
                patentItem.patentDate = "X";
                patentItem.patentTitle = "X";
                patentItem.patentAbstract = "X";
                patentItem.patentDescription = "X";
                patentItem.patentClaims = "X";
                patentItem.patentClaimsCount = "X";
                patentListByWeekParsed.Add(patentItem);
                OutputByWeek.run(patentListByWeekParsed, year.ToString(), "_y06_m01_d03");
                */
                            ...
                            while (reader.ReadToFollowing("us-patent-grant"))
                            {
                                ...
                                foreach (TargetPatentNumber targetPatentNumber in Patent.getTargetPatentNumbers(year))
                                {
                                    if (patentNumber.Contains(targetPatentNumber.targetPatentNumber))
                                    {
                                        ...
                                        //"Patent Number: " + patentItem.patentNumber);
                                        ...
                                        //Console.WriteLine(Environment.NewLine +
                                        //"Patent Title: " + patentItem.patentTitle);
                                        ...
                                        //Console.WriteLine(Environment.NewLine +
                                        //"Patent Abstract: " + patentItem.patentAbstract);
                                        ...
                                        //Console.WriteLine(Environment.NewLine +
                                        //"Patent Description: " + patentItem.patentDescription);
                                        ...
                                        //Console.WriteLine(Environment.NewLine +
                                        //"Patent Claims: " + patentItem.patentClaims);
