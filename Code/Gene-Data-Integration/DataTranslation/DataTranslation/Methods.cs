...
namespace DataTranslation
{
    public class generalMethods
    {
        ...
        public static void createXml(List<Gene> gene_list, string targetFileName)
        {
            ...
            TextWriter writer = new StreamWriter(@"\output\" + targetFileName + ".xml");
    ...
    public class brainMethods
    {
        ...
        public static void Brain_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Brain\Brain.csv"))
            {
                reader.ReadLine();
                int counter = 1;
        ...
        public static void mart_export_brain_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\Brain\input\mart_export_brain.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
    ...
    public class cerebellumMethods
    {
        ...
        public static void Cerebellum_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Cerebellum\Cerebellum.csv"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
        ...
        public static void mart_export_cerebellum_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Cerebellum\mart_export_cerebellum.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
    ...
    public class heartMethods
    {
        ...
        public static void Heart_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Heart\Heart.csv"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
        ...
        public static void mart_export_heart_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Heart\mart_export_heart.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
        ...
        public static void Heart_Ensembl_NCBI_Crosswalk_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Heart\Heart_Ensembl_NCBI_Crosswalk.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
    ...
    public class kidneyMethods
    {
        ...
        public static void Kidney_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Kidney\Kidney.csv"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
        ...
        public static void mart_export_kidney_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Kidney\mart_export_kidney.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
    ...
    public class liverMetods
    {
        ...
        public static void Liver_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Liver\Liver.csv"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
        ...
        public static void mart_export_liver_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Liver\mart_export_liver.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
    ...
    public class testisMethods
    {
        ...
        public static void Testis_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Testis\Testis.csv"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
        ...
        public static void mart_export_testis_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Testis\mart_export_testis.txt"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
    ...
    public class geneDiseaseAssociationsMethods
    {
        public static void all_gene_disease_pmid_associations_dt()
        {
            ...
            using (var reader = new StreamReader(generalMethods.getProjectDirectory() + @"\data\input\Gene-Disease-Associations\all_gene_disease_pmid_associations.tsv"))
            {
                reader.ReadLine();
                int counter = 1;
                while (!reader.EndOfStream)
