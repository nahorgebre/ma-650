...
public class Datasets {
    ...
    public static FusibleDataSet<Gene, Attribute> Brain() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Brain_dt.xml"), "/genes/gene", Brain);
    ...
    public static FusibleDataSet<Gene, Attribute> mart_export_brain() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/mart_export_brain_dt.xml"), "/genes/gene", mart_export_brain);
    ...
    public static FusibleDataSet<Gene, Attribute> Cerebellum() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Cerebellum_dt.xml"), "/genes/gene", Cerebellum);
    ...
    public static FusibleDataSet<Gene, Attribute> mart_export_cerebellum() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/mart_export_cerebellum_dt.xml"), "/genes/gene", mart_export_cerebellum);
    ...
    public static FusibleDataSet<Gene, Attribute> Heart() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Heart_dt.xml"), "/genes/gene", Heart);
    ...
    public static FusibleDataSet<Gene, Attribute> mart_export_heart() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/mart_export_heart_dt.xml"), "/genes/gene", mart_export_heart);
    ...
    public static FusibleDataSet<Gene, Attribute> Heart_Ensembl_NCBI_Crosswalk() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Heart_Ensembl_NCBI_Crosswalk_dt.xml"), "/genes/gene", Heart_Ensembl_NCBI_Crosswalk);
    ...
    public static FusibleDataSet<Gene, Attribute> Kidney() throws Exception {    
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Kidney_dt.xml"), "/genes/gene", Kidney);
    ...
    public static FusibleDataSet<Gene, Attribute> mart_export_kidney() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/mart_export_kidney_dt.xml"), "/genes/gene", mart_export_kidney);
    ...
    public static FusibleDataSet<Gene, Attribute> Liver() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Liver_dt.xml"), "/genes/gene", Liver);
    ...
    public static FusibleDataSet<Gene, Attribute> mart_export_liver() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/mart_export_liver_dt.xml"), "/genes/gene", mart_export_liver);
    ...
    public static FusibleDataSet<Gene, Attribute> Testis() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Testis_dt.xml"), "/genes/gene", Testis);
    ...
    public static FusibleDataSet<Gene, Attribute> mart_export_testis() throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/mart_export_testis_dt.xml"), "/genes/gene", mart_export_testis);
