...
import genes.DataFusion.SAXParser.Disease.ReadDiseaseXML;
import genes.DataFusion.SAXParser.Organ.Organ;
import genes.DataFusion.SAXParser.Organ.ReadOrganXML;
import genes.DataFusion.SAXParser.Patent.Patent;
import genes.DataFusion.SAXParser.Patent.ReadPatentXML;
import genes.DataFusion.SAXParser.Publication.Publication;
import genes.DataFusion.SAXParser.Publication.ReadPublicationXML;
...
public class GeneHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("Gene")) {
            ...
            String provenanceInfo = "test";

            Gene gene = new Gene("", provenanceInfo);
