package genes.IdentityResolution.solutions.DI1.Testis_2_mart_export_testis;
...
public class LR_StandardRecordBlocker {
    ...
    public static void main(String[] args) throws Exception {
        // loading data
        System.out.println("*\n*\tLoading datasets\n*");
        HashedDataSet<Gene, Attribute> ds1 = DI1Datasets.Testis();
        HashedDataSet<Gene, Attribute> ds2 = DI1Datasets.mart_export_testis();
