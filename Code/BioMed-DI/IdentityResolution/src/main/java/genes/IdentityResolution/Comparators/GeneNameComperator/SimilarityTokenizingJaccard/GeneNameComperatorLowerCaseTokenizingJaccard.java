...
public class GeneNameComperatorLowerCaseTokenizingJaccard implements Comparator<Gene, Attribute> {
    ...
    public double compare(
        ...
        comparison.s1 = record1GeneNames.get(0).getName().toLowerCase();
        comparison.s2 = record2GeneNames.get(0).getName().toLowerCase(); 
