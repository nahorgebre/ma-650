package genes.IdentityResolution.solutions.DI1.Cerebellum_2_Brain;
...
public class LR_SortedNeighbourhoodBlocker 
{
    ...
    public static void main( String[] args ) throws Exception
    {
		// loading data
        System.out.println("*\n*\tLoading datasets\n*");
        HashedDataSet<Gene, Attribute> ds1 = DI1Datasets.Cerebellum();
        HashedDataSet<Gene, Attribute> ds2 = DI1Datasets.Brain();

		// load the gold standard (test set)
        String comparisonDescription = "Cerebellum_2_Brain";
        String solution = "DI1";
