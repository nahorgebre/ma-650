...
namespace Data_Preparation
{
    class CreateTrainTextDatasets
    {
        ...
        {
            create_patents_train_text_title();
            create_patents_train_text_abstract();
        }


        public static void create_patents_train_text_title() {
            ...
            FileInfo fileName = new FileInfo(string.Format("{0}/patents_train_text_title.txt", outputDirectory.FullName));
            fileName.Delete();
                ...
                foreach (FileInfo patents_text in patents_text_list)
                {
                    using (StreamReader sr = new StreamReader(patents_text.FullName))
                    {
                        ...
                        while(!sr.EndOfStream)
                        {
                            ...
                            CreateTrainTextDatasets datasetItem = new CreateTrainTextDatasets();
        ...
        public static void create_patents_train_text_abstract() {
            ...
            FileInfo fileName = new FileInfo(string.Format("{0}/patents_train_text_abstract.txt", outputDirectory.FullName));
            fileName.Delete();
