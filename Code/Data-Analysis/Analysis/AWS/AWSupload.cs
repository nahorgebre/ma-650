...
namespace Analysis
{
    ...
    public class AWSupload
    {
        ...
        public static void run()
        {
            ...
            DirectoryInfo outpuDirectory = new DirectoryInfo(string.Format("{0}/data/output/", Environment.CurrentDirectory));

            foreach (FileInfo file in outpuDirectory.GetFiles())
            {

                string keyName = string.Format("data-analysis/analysis1/{0}", file.Name);
