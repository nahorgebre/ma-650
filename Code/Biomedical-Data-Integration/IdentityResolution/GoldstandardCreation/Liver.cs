...
namespace GoldstandardCreation
{
    class Liver
    {
        ...
        public static void Liver_2_mart_export_liver() {
            List<Goldstandard> goldstandardList = Methods.compareEnsemblId(Datasets.Liver_path, Datasets.mart_export_liver_path);
            Methods.createOuput("Liver_2_mart_export_liver", goldstandardList);
        }
        ...
        public static void mart_export_liver_2_all_gene_disease_pmid_associations() {
            ...
            Methods.createOuput("mart_export_liver_2_all_gene_disease_pmid_associations", goldstandardList);
        }
        ...
        public static void mart_export_liver_2_gene2pubtatorcentral() {
            ...
            Methods.createOuput("mart_export_liver_2_gene2pubtatorcentral", goldstandardList);
        }
    }
}