...
namespace GoldstandardCreation
{
    class Liver
    {
        ...
        public static void Liver_2_mart_export_liver() {
            ...
            Methods.createOuput("Liver_2_mart_export_liver", "true.csv", goldstandardList);
        }
        ...
        public static void mart_export_liver_2_all_gene_disease_pmid_associations() {
            ...
            Methods.createOuput("mart_export_liver_2_all_gene_disease_pmid_associations", "true.csv", goldstandardList);
        }
