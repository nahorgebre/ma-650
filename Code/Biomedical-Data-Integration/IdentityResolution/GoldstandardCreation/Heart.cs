...
namespace GoldstandardCreation
{
    class Heart
    {
        ...
        public static void Heart_2_Heart_Ensembl_NCBI_Crosswalk() {
            ...
            Methods.createOuput("Heart_2_Heart_Ensembl_NCBI_Crosswalk", goldstandardList);
        }
        ...
        public static void Heart_Ensembl_NCBI_Crosswalk_2_all_gene_disease_pmid_associations() {
            ...
            Methods.createOuput("Heart_Ensembl_NCBI_Crosswalk_2_all_gene_disease_pmid_associations", goldstandardList);       
        }
        ...
        public static void Heart_Ensembl_NCBI_Crosswalk_2_gene2pubtatorcentral() {
            ...
            Methods.createOuput("Heart_Ensembl_NCBI_Crosswalk_2_gene2pubtatorcentral", goldstandardList);
        }
        ...
        public static void mart_export_heart_2_Heart_Ensembl_NCBI_Crosswalk() {
            ...
            Methods.createOuput("mart_export_heart_2_Heart_Ensembl_NCBI_Crosswalk", goldstandardList);
        }
