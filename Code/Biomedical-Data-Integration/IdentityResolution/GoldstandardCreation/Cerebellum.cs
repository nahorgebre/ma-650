...
namespace GoldstandardCreation
{
    class Cerebellum
    {
        ...
        public static void Cerebellum_2_mart_export_cerebellum() {
            ...
            Methods.createOuput("Cerebellum_2_mart_export_cerebellum", "true.csv", goldstandardList);
        }
        ...
        public static void mart_export_cerebellum_2_all_gene_disease_pmid_associations() {
            ...
            Methods.createOuput("mart_export_cerebellum_2_all_gene_disease_pmid_associations", "true.csv", goldstandardList);
        }
        ...
        public static void mart_export_cerebellum_2_gene2pubtatorcentral() {
            ...
            Methods.createOuput("mart_export_cerebellum_2_gene2pubtatorcentral", "true.csv", goldstandardList);
        }
        */
    }
}