...
namespace GoldstandardCreation
{
    class Brain
    {
        ...
        public static void Brain_2_mart_export_brain() {
            ...
            Methods.createOuput("Brain_2_mart_export_brain", goldstandardList);
        }
        ...
        public static void mart_export_brain_2_all_gene_disease_pmid_associations() {
            ...
            Methods.createOuput("mart_export_brain_2_all_gene_disease_pmid_associations", goldstandardList);
        }
        ...
        public static void mart_export_brain_2_gene2pubtatorcentral() {
            ...
            Methods.createOuput("mart_export_brain_2_gene2pubtatorcentral", goldstandardList);
        }
    }
}