    ...
    class Brain
    {
        ...
        public static void mart_export_brain_2_gene2pubtatorcentral() {
            for (int i = 1; i <= 35; i++)
            {
                ...
                {
                    Console.WriteLine(System.Reflection.MethodBase.GetCurrentMethod().Name);
                    (List<Goldstandard> trueList, List<Goldstandard> falseList) = Methods.compareFiles20(Datasets.mart_export_brain_path, Datasets.getGene2pubtatorcentral_path(i), 3);
                    Methods.createOuput(trueFile, trueList);
                    Methods.createOuput(falseFile, falseList);
                } 
            }
