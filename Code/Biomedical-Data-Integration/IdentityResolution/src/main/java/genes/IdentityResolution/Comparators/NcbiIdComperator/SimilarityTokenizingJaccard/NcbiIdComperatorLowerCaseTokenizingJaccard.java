package genes.IdentityResolution.Comparators.NcbiIdComperator.SimilarityTokenizingJaccard;
...
public class NcbiIdComperatorLowerCaseTokenizingJaccard implements Comparator<Gene, Attribute> {
