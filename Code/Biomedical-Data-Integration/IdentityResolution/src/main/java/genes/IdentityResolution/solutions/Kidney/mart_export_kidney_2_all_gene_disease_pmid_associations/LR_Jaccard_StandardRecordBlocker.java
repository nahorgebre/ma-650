...
public class LR_Jaccard_StandardRecordBlocker 
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        String outputDirectory = "data/output/Kidney/" + comparisonDescription;
        new File(outputDirectory).mkdirs();

        // create a matching rule
        LinearCombinationMatchingRule<Gene, Attribute> matchingRule = new LinearCombinationMatchingRule<>(
                0.9);
        matchingRule.activateDebugReport("data/output/Kidney/mart_export_kidney_2_all_gene_disease_pmid_associations/debugResultsMatchingRule_.csv", 1000, gsTest);
        ...
        blocker.collectBlockSizeData("data/output/Kidney/mart_export_kidney_2_all_gene_disease_pmid_associations/debugResultsBlocking_.csv", 100);
