package genes.IdentityResolution.Comparators.PmIdComperator.SimilarityLevenshtein;
...
public class PmIdComperatorLevenshtein implements Comparator<Publication, Attribute> {
