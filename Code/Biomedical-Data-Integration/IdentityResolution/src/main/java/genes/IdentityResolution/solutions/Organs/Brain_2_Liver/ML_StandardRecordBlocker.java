package genes.IdentityResolution.solutions.Organs.Brain_2_Liver;
...
public class ML_StandardRecordBlocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        for (GeneWekaMatchingRule geneMatchingRule : matchingRuleList) {
            ...
            learner.learnMatchingRule(Brain, Liver, null, matchingRule, gsTrain);
            ...
            Processable<Correspondence<Gene, Attribute>> correspondences = engine.runIdentityResolution(
                Brain, Liver, null, matchingRule, blocker);
