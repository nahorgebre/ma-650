...
public class ML_StandardRecordBlocker {
    ...
    {            
        ...
        for (GeneWekaMatchingRule geneMatchingRule : matchingRuleList) {
            ...
            String className = geneMatchingRule.modelType + blockerName;
            ...
            learner.learnMatchingRule(all_gene_disease_pmid_associations, mart_export_testis, null, matchingRule, gsTrain);
            ...
            Processable<Correspondence<Gene, Attribute>> correspondences = engine.runIdentityResolution(
                all_gene_disease_pmid_associations, mart_export_testis, null, matchingRule, blocker);
