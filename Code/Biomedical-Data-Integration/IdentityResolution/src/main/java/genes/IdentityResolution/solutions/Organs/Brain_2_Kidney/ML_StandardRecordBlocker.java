package genes.IdentityResolution.solutions.Organs.Brain_2_Kidney;
...
public class ML_StandardRecordBlocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        for (GeneWekaMatchingRule geneMatchingRule : matchingRuleList) {
            ...
            learner.learnMatchingRule(Kidney, Brain, null, matchingRule, gsTrain);
            ...
            Processable<Correspondence<Gene, Attribute>> correspondences = engine.runIdentityResolution(
                Kidney, Brain, null, matchingRule, blocker);
