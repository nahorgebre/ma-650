...
public class GeneLinearCombinationMatchingRule_EnsemblId {
    ...
    public static List<GeneLinearCombinationMatchingRule_EnsemblId> getMatchingRuleList(String solution, String comparisonDescription, String blockerName, MatchingGoldStandard gsTest) throws Exception {
        ...
        cosine.matchingRule = EnsemblId_Cosine(outputDirectory = cosine.outputDirectory, gsTest = gsTest);
        ...
        jaccard.matchingRule = EnsemblId_Jaccard(outputDirectory = jaccard.outputDirectory, gsTest = gsTest);
        ...
        levenshtein.matchingRule = EnsemblId_Levenshtein(outputDirectory = levenshtein.outputDirectory, gsTest = gsTest);
        ...
        sorensenDice.matchingRule = EnsemblId_SorensenDice(outputDirectory = sorensenDice.outputDirectory, gsTest = gsTest);
    ...
    public static LinearCombinationMatchingRule<Gene, Attribute> EnsemblId_Cosine(String outputDirectory, MatchingGoldStandard gsTest) throws Exception {
        LinearCombinationMatchingRule<Gene, Attribute> matchingRule = createMatchingRule(outputDirectory = outputDirectory, gsTest = gsTest);
