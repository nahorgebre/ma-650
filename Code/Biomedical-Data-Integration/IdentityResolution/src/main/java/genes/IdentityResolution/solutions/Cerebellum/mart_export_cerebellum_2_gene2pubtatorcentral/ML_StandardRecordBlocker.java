package genes.IdentityResolution.solutions.Cerebellum.mart_export_cerebellum_2_gene2pubtatorcentral;
...
public class ML_StandardRecordBlocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        for (int fileNumber = 1; fileNumber <= Variables.partitionNumbers; fileNumber++) {
            ...
            String comparisonDescription = "mart_export_cerebellum_2_gene2pubtatorcentral_" + fileNumber;
            ...
            for (GeneWekaMatchingRule geneMatchingRule : matchingRuleList) {
                ...
                learner.learnMatchingRule(gene2pubtatorcentral, mart_export_cerebellum, null, matchingRule, gsTrain);
                ...
                Processable<Correspondence<Gene, Attribute>> correspondences = engine.runIdentityResolution(
                    gene2pubtatorcentral, mart_export_cerebellum, null, matchingRule, blocker);
