package genes.IdentityResolution.solutions.Kaessmann.Liver_2_mart_export_liver;
...
public class LR_StandardRecordBlocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        // loading datasets
        System.out.println("*\n*\tLoading datasets\n*");
        HashedDataSet<Gene, Attribute> ds1 = Datasets.Liver();
        HashedDataSet<Gene, Attribute> ds2 = Datasets.mart_export_liver();
