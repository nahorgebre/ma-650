package genes.IdentityResolution.solutions.Kidney.mart_export_kidney_2_gene2pubtatorcentral;
...
public class ML_StandardRecordBlocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        for (int fileNumber = 1; fileNumber <= 35; fileNumber++) {
            ...
            String comparisonDescription = "mart_export_kidney_2_gene2pubtatorcentral_" + fileNumber;
            ...
            for (GeneWekaMatchingRule geneMatchingRule : matchingRuleList) {
                ...
                learner.learnMatchingRule(gene2pubtatorcentral, mart_export_kidney, null, matchingRule, gsTrain);
                ...
                Processable<Correspondence<Gene, Attribute>> correspondences = engine.runIdentityResolution(
                    gene2pubtatorcentral, mart_export_kidney, null, matchingRule, blocker);
