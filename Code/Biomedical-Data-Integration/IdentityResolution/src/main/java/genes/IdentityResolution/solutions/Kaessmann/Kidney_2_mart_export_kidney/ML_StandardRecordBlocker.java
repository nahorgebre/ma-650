package genes.IdentityResolution.solutions.Kaessmann.Kidney_2_mart_export_kidney;
...
public class ML_StandardRecordBlocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        // loading datasets
        System.out.println("*\n*\tLoading datasets\n*");
        HashedDataSet<Gene, Attribute> ds1 = Datasets.Kidney();
        HashedDataSet<Gene, Attribute> ds2 = Datasets.mart_export_kidney();
