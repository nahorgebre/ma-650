...
public class LR_Jaccard_StandardRecordBlocker 
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        gsTest.loadFromCSVFile(new File("data/goldstandard/Brain/Brain_2_mart_export_brain.csv"));

        // create debug folder
        new File("data/output/Brain/Brain_2_mart_export_brain").mkdirs();

        // create a matching rule
        LinearCombinationMatchingRule<Gene, Attribute> matchingRule = new LinearCombinationMatchingRule<>(
                0.9);
        matchingRule.activateDebugReport("data/output/Brain/Brain_2_mart_export_brain/debugResultsMatchingRule.csv", 1000, gsTest);
        ...
        blocker.collectBlockSizeData("data/output/Brain/Brain_2_mart_export_brain/debugResultsBlocking.csv", 100);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/Brain/Brain_2_mart_export_brain/Brain_2_mart_export_brain_correspondences.csv"), correspondences);
        ...
        System.out.println("Brain <-> mart_export_brain");
