...
public class LR_Jaccard_StandardRecordBlocker 
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        LinearCombinationMatchingRule<Gene, Attribute> matchingRule = new LinearCombinationMatchingRule<>(
                0.9);
        matchingRule.activateDebugReport("data/output/Brain/mart_export_brain_2_all_gene_disease_pmid_associations/debugResultsMatchingRule_LR.csv", 1000, gsTest);
        ...
        blocker.collectBlockSizeData("data/output/Brain/mart_export_brain_2_all_gene_disease_pmid_associations/debugResultsBlocking_LR.csv", 100);
