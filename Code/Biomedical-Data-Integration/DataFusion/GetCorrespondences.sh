...
mkdir -p data/correspondences/Brain/mart_export_brain_2_all_gene_disease_pmid_associations
...
mkdir -p data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations
...
wget -N https://nahorgebre-ma-650-master-thesis.s3.us-east-2.amazonaws.com/data-fusion/correspondences/Kidney/Kidney_2_mart_export_kidney/correspondences.csv -O data/correspondences/Kidney/Kidney_2_mart_export_kidney/correspondences.csv
mkdir -p data/correspondences/Kidney/mart_export_kidney_2_all_gene_disease_pmid_associations

# Liver
mkdir -p data/correspondences/Liver/Liver_2_mart_export_liver
wget -N https://nahorgebre-ma-650-master-thesis.s3.us-east-2.amazonaws.com/data-fusion/correspondences/Liver/Liver_2_mart_export_liver/correspondences.csv -O data/correspondences/Liver/Liver_2_mart_export_liver/correspondences.csv
mkdir -p data/correspondences/Liver/mart_export_liver_2_all_gene_disease_pmid_associations
