...
namespace DataPreparation
{
    class Brain
    {
            ...
            HashSet<String> Brain_dt = new HashSet<String>();
            List<(int, String)> Brain_dt_recordIds = new List<(int, String)>
            {
                (1, Correspondences.Brain_2_mart_export_brain),
                (2, Correspondences.Heart_2_Brain)
            };

            HashSet<String> mart_export_brain_dt = new HashSet<string>();
            List<(int, String)> mart_export_brain_dt_recordIds = new List<(int, String)>
            {
