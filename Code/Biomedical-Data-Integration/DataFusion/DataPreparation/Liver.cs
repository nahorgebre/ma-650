...
namespace DataPreparation
{
    class Liver
    {
        ...
        {
            Methods.getDistinctRecordIds(Liver_dt_recordIds, "Liver_dt");
            Methods.getDistinctRecordIds(mart_export_liver_dt_recordIds, "mart_export_liver_dt");
        }

        public static List<(int, String)> Liver_dt_recordIds = new List<(int, String)>
        {
            (1, Correspondences.Liver_2_mart_export_liver),
            (2, Correspondences.Heart_2_Liver)
        };

        public static List<(int, String)> mart_export_liver_dt_recordIds = new List<(int, String)>
        {
