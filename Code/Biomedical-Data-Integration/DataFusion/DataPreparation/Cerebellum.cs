...
namespace DataPreparation
{
    class Cerebellum
    {
            HashSet<String> Cerebellum_dt = new HashSet<String>();
            List<(int, String)> Cerebellum_dt_recordIds = new List<(int, String)>
            {
                (1, Correspondences.Cerebellum_2_mart_export_cerebellum),
                (2, Correspondences.Heart_2_Cerebellum)
            };

            HashSet<String> mart_export_cerebellum_dt = new HashSet<String>();
            List<(int, String)> mart_export_cerebellum_dt_recordIds = new List<(int, String)>
            {
