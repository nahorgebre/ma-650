...
public class DiseasesFuserUnion extends AttributeValueFuser<List<Disease>, Gene, Attribute> {

    public DiseasesFuserUnion() {
        super(new Union<Disease, Gene, Attribute>());
    }
