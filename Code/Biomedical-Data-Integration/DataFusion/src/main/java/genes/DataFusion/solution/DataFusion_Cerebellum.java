...
public class DataFusion_Cerebellum {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Cerebellum/Cerebellum_dt.xml"), "/genes/gene", ds1);
        ds1.printDataSetDensityReport();

        FusibleDataSet<Gene, Attribute> ds2 = new FusibleHashedDataSet<>();
        new GeneXMLReader().loadFromXML(new File("data/input/Cerebellum/mart_export_cerebellum_dt.xml"), "/genes/gene", ds2);
        ...
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/Cerebellum_2_mart_export_cerebellum/Cerebellum_2_mart_export_cerebellum_correspondences.csv"),ds1, ds2);

        //2, 3, 6, 7, 8, 11, 13, 15, 19, 20, 21, 22, 23, 24, 25
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_2.csv"),gda2, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_3.csv"),gda3, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_6.csv"),gda6, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_7.csv"),gda7, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_8.csv"),gda8, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_11.csv"),gda11, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_13.csv"),gda13, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_15.csv"),gda15, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_19.csv"),gda19, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_20.csv"),gda20, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_21.csv"),gda21, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_22.csv"),gda22, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_23.csv"),gda23, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_24.csv"),gda24, ds2);
        correspondences.loadCorrespondences(new File("data/correspondences/Cerebellum/mart_export_cerebellum_2_all_gene_disease_pmid_associations/mart_export_cerebellum_2_all_gene_disease_pmid_associations_correspondences_25.csv"),gda25, ds2);
        ...
        new GeneXMLReader().loadFromXML(new File("data/goldstandard/cerebellum-goldstandard.xml"), "/genes/gene", gs);
        ...
        new GeneXMLFormatter().writeXML(new File("data/output/fused-cerebellum.xml"), fusedDataSet);
