...
public class GeneDescriptionEvaluationRule extends EvaluationRule<Gene, Attribute> {

    SimilarityMeasure<String> sim = new TokenizingJaccardSimilarity();

    @Override
    public boolean isEqual(Gene record1, Gene record2, Attribute schemaElement) {
        return sim.calculate(record1.getGeneDescription(), record2.getGeneDescription()) == 1.0;
    }
