...
public class PublicationsFuserFavourSource extends AttributeValueFuser<List<Publication>, Gene, Attribute> {

    public PublicationsFuserFavourSource() {
        super(new FavourSources<List<Publication>, Gene, Attribute>());
    }
