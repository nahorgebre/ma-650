...
public class Disease extends AbstractRecord<Attribute> implements Serializable {
    ...
    public String toString() {
        return String.format("[Disease: %s / %s / %s / %s / %s / %s / %s / %s / %s / %s / %s /]",
                getDiseaseId(), getDiseaseName(), getDiseaseType(), getDiseaseClass(),
                getDiseaseSemanticType(), getScore(), getEi(), getYearInitial(),
                getYearFinal(), getPmid(), getSource());
    }
}
