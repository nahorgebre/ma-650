...
public class DataFusion_Testis {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        new GeneXMLReader().loadFromXML(new File("data/input/Testis/Testis_dt.xml"), "/genes/gene", ds1);
        ds1.printDataSetDensityReport();

        FusibleDataSet<Gene, Attribute> ds2 = new FusibleHashedDataSet<>();
        new GeneXMLReader().loadFromXML(new File("data/input/Testis/mart_export_testis_dt.xml"), "/genes/gene", ds2);
        ...
        correspondences.loadCorrespondences(new File("data/correspondences/Testis/Testis_2_mart_export_testis/Testis_2_mart_export_testis_correspondences.csv"),ds1, ds2);

        // 1, 2, 3, 6, 7, 8, 11, 13, 15, 19, 20, 21, 22, 23, 24, 25
        String correspondencesPath = "data/correspondences/Testis/mart_export_testis_2_all_gene_disease_pmid_associations/mart_export_testis_2_all_gene_disease_pmid_associations_correspondences_";
        ...
        correspondences.loadCorrespondences(new File(correspondencesPath + "11.csv"),gda13, ds2);
        ...
        new GeneXMLReader().loadFromXML(new File("data/goldstandard/testis-goldstandard.xml"), "/genes/gene", gs);

        // define the fusion strategy
        DataFusionStrategy<Gene, Attribute> strategy = new DataFusionStrategy<>(new GeneXMLReader());

        // write debug results to file
        strategy.activateDebugReport("data/output/debugResultsDatafusion-testis.csv", 1000, gs);
        ...
        new GeneXMLFormatter().writeXML(new File("data/output/fused-testis.xml"), fusedDataSet);
