  ...
  \begin{center}
   ...
   \vspace{1cm}{
    ...
    University of Mannheim\\}
		\vspace{1cm}{
		First Supervisor: Prof.\ Dr.\ Marc Lerchenmüller\\
		Second Supervisor: Prof.\ Dr.\ Heiner Stuckenschmidt\\
		}
		\vspace{2cm}
   {2020}
  \end{center}
...
\include{chapter/theoretical-framework}
\include{chapter/solution-approach}
